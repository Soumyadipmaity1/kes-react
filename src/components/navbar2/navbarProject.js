                ...
                <div className="flex justify-between md:w-full md:justify-between px-16">
                    <div className="flex w-full md:justify-between">
                        ...
                        <div className="hidden md:flex md:text-center">
                            <Link to="/" className="mx-[16px] cursor-pointer mt-4    text-white  box-shadow2 px-2  hover:text-[#9700ef] start  ">HOME</Link>
                            <Link to="/Aboutus" className="mx-[20px] cursor-pointer px-2  text-white text-shadow mt-4 box-shadow2  hover:text-[#9700ef] start transition duration-500">ABOUT US</Link>
                            <Link to="/studentblogs" className="mx-[20px] cursor-pointer text-white px-2 mt-4 text-shadow box-shadow2 hover:text-[#9700ef] start transition duration-500  ">STUDENT BLOGS</Link>
                            <Link to="/projects" className="mx-[20px] cursor-pointer text-shadow px-2 mt-4 text-shadow1 box-shadow2 text-[#9700ef] start transition duration-500">PROJECTS</Link>
                            <Link to="/achievement" className="mx-[16px] mt-4  cursor-pointer box-shadow3 text-white px-2 hover:text-[#9700ef] text-shadow start transition duration-500">ACHIEVEMENTS</Link>
                        </div>
                    </div>
